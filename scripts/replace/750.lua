...
stone = script.Parent.TerrainParts.Stone:GetChildren()
dirt = script.Parent.TerrainParts.Dirt:GetChildren()
snow = script.Parent.TerrainParts.Snow:GetChildren()
for i = 1,#stone do
	Settings.MaterialSelected = 15
	AddTerrain(stone[i])
end
for i = 1,#dirt do
	Settings.MaterialSelected = 9
	--Settings.MaterialSelected = 18
	AddTerrain(dirt[i])
end
for i = 1,#snow do
	Settings.MaterialSelected = 20
	AddTerrain(snow[i])
end