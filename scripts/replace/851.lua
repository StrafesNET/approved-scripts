...
game.Workspace.Terrain.WaterReflectance = 0.25
game.Workspace.Terrain.WaterTransparency = 0.5
game.Workspace.Terrain.WaterWaveSize = 0
game.Workspace.Terrain.WaterWaveSpeed = 30
game.Workspace.Terrain.WaterColor = Color3.fromRGB(61, 89, 111)