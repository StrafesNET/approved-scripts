...
InsertStateTransition(0.4,function()
	Part.Image = "rbxassetid://3355714046"
end)
InsertStateTransition(0.4,function()
	Part.Image = "rbxassetid://3355714809"
end)
InsertStateTransition(0.3,function()
	Part.Image = "rbxassetid://3355964365"
end)
