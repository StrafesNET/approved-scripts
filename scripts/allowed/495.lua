...
--rot=CFrameToAxisAngle(CFrame.fromEulerAnglesXYZ(-0.04,0.04,-0.04))

local tick=tick
local tau=math.pi*2
local RotAxis=Vector3.new(-0.584895670413971,0.5619556307792664,-0.584895670413971)
local RotSpeed=0.06973778875880074*30
