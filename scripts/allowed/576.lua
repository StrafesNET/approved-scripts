...
--state transition every 0.7s
InsertStateTransition(0.7,function()
	Part.Image = "rbxassetid://3351170857"
end)
InsertStateTransition(0.7,function()
	Part.Image = "rbxassetid://3351172377"
end)
InsertStateTransition(0.7,function()
	Part.Image = "rbxassetid://3351173433"
end)
